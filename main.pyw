...
button1 = tkinter.Button(text="On/Off", height=1, width=10, background = "gray20", activebackground = "gray20", foreground="white", activeforeground="white", command = switchMove)
...
button2 = tkinter.Button(text="Exit", height=1, width=10, background = "gray20", activebackground = "gray20", foreground="white", activeforeground="white", command = window.destroy)
